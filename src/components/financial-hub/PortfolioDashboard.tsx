...
import { TrendingUp, Wallet, BarChart3, Users, RefreshCw, Zap, Shield, Trophy, MapPin } from "lucide-react";
                        ...
                        <CardContent className="p-6 flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-2xl font-bold bg-gradient-cosmic bg-clip-text text-transparent">
                                    {totalValue.toLocaleString()} xBGL
                                </h3>
                            </div>
                        ...
                        <CardContent className="p-6 flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-2xl font-bold text-foreground">
                                    {(() => {
                                        const plotHoldings = primaryPortfolio?.holdings?.filter((h: any) => h.asset_type === "plot") || [];
                                        return plotHoldings.length;
                                    })()}
                                </h3>
                                <p className="text-xs text-muted-foreground mt-1">
                                    {(() => {
                                        const plotHoldings = primaryPortfolio?.holdings?.filter((h: any) => h.asset_type === "plot") || [];
                                        const totalValue = plotHoldings.reduce((sum: number, h: any) => sum + (h.cost_basis || 0), 0);
                    ...
                    <Card className="glass border-primary/20 anime-card">
                        <CardContent className="p-6 flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-2xl font-bold text-foreground">
                                    {parseFloat(csnBalance).toFixed(2)} xBGL
                                </h3>
                            </div>
                    ...
                    <Card className="glass border-primary/20 anime-card">
                        <CardContent className="p-6 flex items-center justify-between">
                            <div>
                                ...
                                <h3 className="text-2xl font-bold text-foreground">
                                    {monthlyContribution.toLocaleString()} xBGL
                                </h3>
                            </div>
